...
export const resolvers: Resolvers = {
  Query: {
    ...
    bestPracticeTemplates: async (_, __, context: MyContext): Promise<VersionedTemplate[]> => {
    ...
    publishedTemplate: async (_, { publishedTemplateId }, context: MyContext): Promise<VersionedTemplate> => {
