...
verifyCriticalEnvVariable(process.env.DOMAIN, 'DOMAIN');
verifyCriticalEnvVariable(process.env.APP_NAME, 'APP_NAME');
verifyCriticalEnvVariable(process.env.DEFAULT_AFFILIATION_URI, 'DEFAULT_AFFILIATION_URI');
verifyCriticalEnvVariable(process.env.DMP_ID_SHOULDER, 'DMP_ID_SHOULDER');
verifyCriticalEnvVariable(process.env.TOKEN_HASH_SECRET, 'TOKEN_HASH_SECRET');
verifyCriticalEnvVariable(process.env.JWT_SECRET, 'JWT_SECRET');
verifyCriticalEnvVariable(process.env.JWT_REFRESH_SECRET, 'JWT_REFRESH_SECRET');
