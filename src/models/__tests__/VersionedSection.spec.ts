...
import { VersionedSection, versionedSectionsByNameQuery, versionedSectionsBySectionIdQuery } from "../VersionedSection";
...
describe('getVersionedSectionById', () => {
    ...
    it('should call query with correct params and return the section', async () => {
        ...
        const sectionId = 1;
        const result = await VersionedSection.getVersionedSectionById('VersionedSection query', context, sectionId);
...
describe('getVersionedSectionsBySectionId', () => {
    ...
    it('should call query with correct params and return the section', async () => {
        ...
        const expectedSql = versionedSectionsBySectionIdQuery;
        expect(localQuery).toHaveBeenCalledTimes(1);
        expect(localQuery).toHaveBeenLastCalledWith(context, expectedSql, [sectionId.toString()], 'VersionedSection query')
...
the getVersionedSectionsBySectionId method returns an empty array for tags, and not undefined*/
        expect(result).toEqual([{ ...versionedSection, ...{ tags: [] } }]);
    });
...
describe('getVersionedSectionsByName', () => {
    ...
    it('should call query with correct params and return the section', async () => {
        ...
        const expectedSql = versionedSectionsByNameQuery;
