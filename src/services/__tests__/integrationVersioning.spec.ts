  ...
  beforeEach(() => {
    ...
    questionStore = [
      new Question({
        ...
        questionType: `{"type":"boolean","meta":{"schemaVersion":"${CURRENT_SCHEMA_VERSION}"}}`,
      ...
      new Question({
        ...
        questionType: `{"type":"text","meta":{"schemaVersion":"${CURRENT_SCHEMA_VERSION}"}}`,
        questionText: casual.sentences(2),
        requirementText: casual.sentences(3),
        guidanceText: casual.sentences(2),
        sampleText: casual.sentences(2),
      ...
      new Question({
        ...
        templateId: templateStore[0].id,
        sectionId: sectionStore[1].id,
        questionType: `{"type":"email","meta":{"schemaVersion":"${CURRENT_SCHEMA_VERSION}"}}`,
        questionText: casual.sentences(2),
        requirementText: casual.sentences(3),
        guidanceText: casual.sentences(2),
        sampleText: casual.sentences(2),
