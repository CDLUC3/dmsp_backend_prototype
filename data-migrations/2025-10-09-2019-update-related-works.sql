...
ALTER TABLE `relatedWorks`
  ...
  ADD COLUMN `sourceType` VARCHAR(32) NOT NULL,
  MODIFY COLUMN `doiMatch` JSON NULL,
  MODIFY COLUMN `contentMatch` JSON NULL,
  MODIFY COLUMN `authorMatches` JSON NULL,
  MODIFY COLUMN `institutionMatches` JSON NULL,
  MODIFY COLUMN `funderMatches` JSON NULL,
  MODIFY COLUMN `awardMatches` JSON NULL,
