...
### Chore
- Updated `uuid` to `v14.0.2`, `@aws-sdk/client-dynamodb` to `v3.1127.0`, `@aws-sdk/client-ssm` to `v3.1127.0`, `@aws-sdk/credential-providers` to `3.1127.0`, `@aws-sdk/util-dynamodb` to `v3.996.9`, `eslint` to `v10.10.0`, `globals` to `v17.12.0`, and `nock` to `v14.0.17`
